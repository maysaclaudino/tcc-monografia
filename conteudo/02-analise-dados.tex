...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{imagens/mapas/ocorrencias-por-km2.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{imagens/mapas/regiao-analise.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{imagens/mapas/correlacao-pearson-cge-inmet.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{imagens/heatmap-precipitacao-eventos.png}
