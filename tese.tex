...
\author[fem]{Maysa Cristina Claudino da Silva}
...
% \usepackage{hyperref}
% \usepackage{xcolor}
% \UseTblrLibrary{booktabs} % para linhas horizontais mais elegantes
% \usepackage{fvextra}
...
%    Pesquisa OD & Pesquisa Origem-Destino\\
%    RMSP & Região Metropolitana de São Paulo\\
%    CGE & Companhia de Engenharia de Tráfego\\
% \end{tabular}
...
% \pagestyle{mainmatter}
\input{conteudo/01-cenario}
\input{conteudo/02-analise-dados}
\input{conteudo/03-interscsimulator}
